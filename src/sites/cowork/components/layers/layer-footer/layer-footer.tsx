import FooterLegals from '@/sites/cowork/components/molecules/footer-legals/footer-legals'
import FooterNav from '@/sites/cowork/components/molecules/footer-nav/footer-nav'
import Newsletter from '@/sites/cowork/components/molecules/newsletter/newsletter'
