...
import Paragraph from '@/sites/cowork/components/atoms/paragraph/paragraph'
import SectionHeading from '@/sites/cowork/components/atoms/section-heading/section-heading'
import Subtitle from '@/sites/cowork/components/atoms/subtitle/subtitle'
import BlogTeaser from '@/sites/cowork/components/molecules/blog-teaser/blog-teaser'
import List from '@/shared/components/molecules/list/list'
import { BLOG_TEASERS } from '@/sites/cowork/data/BLOG_TEASERS'
